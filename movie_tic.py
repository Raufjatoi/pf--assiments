#Write a function that calculates the movie ticket price based on age (adult, child, senior) and day of the week (weekday, weekend).
#Modify the function to offer discounts for groups or family packages.
